...
{
    public class MessageProcessor_v3_lat : MessageProcessor_v2
    {
        #region vars
        ILogger logger;
        #endregion

        public MessageProcessor_v3_lat(string geotag, string token, ITelegramBotClient bot, ILogger logger) : base(geotag, token, bot)
        {
            this.logger = logger;
        }
        ...
        override protected InlineKeyboardMarkup getRegMarkup(string start_param, string? link, string pm, string uuid)
        {
            ...
            reg_buttons[0] = new InlineKeyboardButton[] { InlineKeyboardButton.WithWebApp(text: "🔥 REGISTRO", new WebAppInfo() { Url = getRegUrl(start_param, link, pm, uuid) }) };
        ...
        override protected InlineKeyboardMarkup getFDMarkup(string start_param, string pm, string? link, string uuid)
        {
            ...
            dep_buttons[0] = new InlineKeyboardButton[] { InlineKeyboardButton.WithWebApp(text: "💰 DEPÓSITO", new WebAppInfo() { Url = getFDUrl(start_param, link, pm, uuid) }) };
        ...
        override protected InlineKeyboardMarkup getVipMarkup(string start_param, string pm, string? link, string channel, string uuid)
        {
            ...
            vip_buttons[0] = new InlineKeyboardButton[] { InlineKeyboardButton.WithWebApp(text: "💰 JUGAR 💰", new WebAppInfo() { Url = getVipUrl(start_param, link, pm, uuid) }) };
        ...
        override protected InlineKeyboardMarkup getRegPushMarkup(string start_param, string? link, string pm, string uuid)
        {
            ...
            buttons[0] = new InlineKeyboardButton[] { InlineKeyboardButton.WithWebApp(text: "✅ REGISTRO ✅", new WebAppInfo() { Url = getRegUrl(start_param, link, pm, uuid) }) };
