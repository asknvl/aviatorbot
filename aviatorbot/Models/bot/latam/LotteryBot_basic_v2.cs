...
{
    public class LotteryBot_basic_v2 : LatamBotBase
    {
        ...
        public override BotType Type => BotType.lottery_basic_v2;

        public LotteryBot_basic_v2(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
