...
{
    public class ModeratorBot_itaa07_raceup : LatamBotBase
    {
        ...
        public override BotType Type => BotType.moderator_itaa07_raceup;

        public ModeratorBot_itaa07_raceup(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
