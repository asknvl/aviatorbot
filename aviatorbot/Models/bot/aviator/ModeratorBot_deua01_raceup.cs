...
{
    public class ModeratorBot_deua01_raceup : LatamBotBase
    {
        ...
        public override BotType Type => BotType.moderator_deua01_raceup;

        public ModeratorBot_deua01_raceup(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
