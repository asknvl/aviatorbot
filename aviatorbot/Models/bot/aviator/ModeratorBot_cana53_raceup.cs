...
{
    public class ModeratorBot_cana53_raceup : LatamBotBase
    {
        ...
        public override BotType Type => BotType.moderator_cana53_raceup;

        public ModeratorBot_cana53_raceup(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
