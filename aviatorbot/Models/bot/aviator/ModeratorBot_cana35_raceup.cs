...
{
    public class ModeratorBot_cana35_raceup : LatamBotBase
    {
        ...
        public override BotType Type => BotType.moderator_cana35_raceup;

        public ModeratorBot_cana35_raceup(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
