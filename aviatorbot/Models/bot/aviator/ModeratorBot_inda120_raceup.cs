...
{
    public class ModeratorBot_inda120_raceup : LatamBotBase
    {
        ...
        public override BotType Type => BotType.moderator_inda120_raceup;

        public ModeratorBot_inda120_raceup(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger) : base(model, operatorStorage, botStorage, logger)
        {
