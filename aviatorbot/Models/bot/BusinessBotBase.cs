...
{
    public abstract class BusinessBotBase : ViewModelBase, INotifyObserver, IDiagnosticsResulter
    {
        ...
        public BusinessBotBase(BotModel model, IOperatorStorage operatorStorage, IBotStorage botStorage, ILogger logger)
        {
        ...
        protected virtual Task processBusiness(Update update, CancellationToken cancellationToken)
        {
            ...
            switch (update.Type)
            {
                ...
                case UpdateType.BusinessMessage:
                    if (update.BusinessMessage != null) 
                        await processBusiness(update, cancellationToken);
                    break;                
            }
        }
